...
describe('Try to submit form with attached file with size lower then 2Mb, JPG format and name which contains 29characters. Other poles filled corretly.', ()=>{
...
it('Type correct First Name and check does this pole contain correct first name', () => {
  ...
  // Attach file
  it('Attach file lower then 2Mb, jpg format and name longer then 20 characters',()=>{
    cy.get('#fileUpload').attachFile('thisIsTheFileWithLongName.jpg')
  })
  ...
  it('Check does error box contains message "Incorrect File Name"', ()=>{
    cy.get('#error > .errorCell').should('include.text', 'Incorrect File Name')
  })
