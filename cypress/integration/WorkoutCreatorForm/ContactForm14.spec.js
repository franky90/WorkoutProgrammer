...
describe('Try to import multiple files (2) with correct size and format. Other poles filled corretly', ()=>{
...
it('Type correct First Name and check does this pole contain correct first name', () => {
  ...
  // Attach file
  it('Attach 2 files lower then 2Mb and jpg format',()=>{
    cy.get('#fileUpload').attachFile('testPicture.jpg')

    cy.get('#fileUpload').attachFile('testPicture2.jpg')
  })
