...
describe('Try to submit form with attached file of size 11Mb. Other poles filled corretly', ()=>{
...
it('Type correct First Name and check does this pole contain correct first name', () => {
  ...
  // Attach file
  it('Attach file bigger then 2Mb and jpg format',()=>{
    cy.get('#fileUpload').attachFile('testBigFile.jpg')
  })
  ...
  it('Check does error box contains message "Incorrect File Size"', ()=>{
    cy.get('#error > .errorCell').should('include.text', 'Incorrect File Size')
  })
